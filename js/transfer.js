...
//     .map((_, index) => `Item ${index + 1}`);
  ...
  var newsArray = ["<b>26 June 2021</b>","Churchill Brothers In Advanced Talks To Sign Shadi Skaf | IFTWC","Debjit Majumder is in advanced talks with Chennaiyin FC | IFTWC","Narayan Das set to join Chennaiyin FC | The Final Whistle","Churchill Brothers In Advanced Talks To Sign Shadi Skaf","FC Goa have triggered a two-year extension in Ishan Pandita’s contract but will allow the striker to leave if the opportunity arises to play in Europe","Neroca FC roped in former Punjab FC defender Danilo Quipapa","Neroca FC have retained the services of youngster Benjamin Lupheng","Former East Bengal FC player Jacques Maghoma has joined Spalding United in England","Mohammedan SC are set to rope in wingback Lalramchullova from East Bengal","Centre Back PC Laldinpuia has signed for Jamshedpur FC",
