...
var newsArray = ["EFL Championship side Coventry City and a Cyprus based club are interested in signing Bright Enobakhare – KhelNow.com","Stephen Eze will not be a part of the Jamshedpur FC in the upcoming Indian Super League","Mohammedan SC have extended the contract of local lad SK Faiaz for the upcoming season","Trau FC in advance stages to sign Brandon Vanlalremdika from Aizawl FC & Khangam Horam from Neroca FC","Trau FC all set to retain their Brazilian defender Helder Lobato and sent contract paper to their former player Gerard Williams",
