...
//     .map((_, index) => `Item ${index + 1}`);
  ...
  var newsArray = ["<b>26 June 2021</b>", "FC Goa have triggered a two-year extension in Ishan Pandita’s contract but will allow the striker to leave if the opportunity arises to play in Europe","Neroca FC roped in former Punjab FC defender Danilo Quipapa",
