...
//     .map((_, index) => `Item ${index + 1}`);
  ...
  var newsArray = ["<b>24 June 2021</b>", "Mohammedan SC extends the contract of Sanjib Ghosh till 2023", "ATK Mohun Bagan are eyeing multiple players from Euro Cup - in talks with Finnish midfielder Joni KaukoIvan and Trickovski who plays as striker for North Macedonia", "FC Goa has signed Sporting Clube de Goa defender Kunal Kundaikar on a three-year deal",
