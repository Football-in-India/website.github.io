...
//     .map((_, index) => `Item ${index + 1}`);
  ...
  var newsArray = ["<b>27 June 2021</b>","Mohammedan SC Retains the services of Azharuddin Mallick Till 2023","Sreenidhi FC rope in 20-year-old defender Lalchungnunga","Samad Ali Mallik is set to join I-League debutants Sreenidhi FC for the upcoming season",
