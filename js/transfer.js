...
var newsArray = ["Kabir Toufik has joined Mohammedan SC from Chennai City FC","Debjit Majumdar has announced that he has left SC East Bengal","Chennaiyin FC announces the signing of 25-year-old center-back Salam Ranjan Singh from ATK Mohun Bagan","TRAU FC have announced the signing of forward Joysana Nongthombam from Chennaiyin FC","Sreenidhi Deccan FC are all set to announce the signing of midfielder Lalromawia from Gokulam Kerala FC","Takhellambam Deepak Singh has joined Gokulam Kerala FC from Neroca FC",
